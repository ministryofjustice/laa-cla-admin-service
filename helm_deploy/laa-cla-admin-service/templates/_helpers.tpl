...
*/}}
{{- define "laa-cla-admin-service.name" -}}
...
*/}}
{{- define "laa-cla-admin-service.fullname" -}}
...
{{- define "laa-cla-admin-service.whitelist" -}}
...
*/}}
{{- define "laa-cla-admin-service.chart" -}}
...
Common labels
*/}}
{{- define "laa-cla-admin-service.labels" -}}
helm.sh/chart: {{ include "laa-cla-admin-service.chart" . }}
{{ include "laa-cla-admin-service.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "laa-cla-admin-service.selectorLabels" -}}
app.kubernetes.io/name: {{ include "laa-cla-admin-service.name" . }}
